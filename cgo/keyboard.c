...
// # Author: realjf                                                            #
// # -----                                                                     #
// # Last Modified: 2024/12/01 14:39:27                                        #
// # Modified By: realjf                                                       #
// # -----                                                                     #
// #                                                                           #
// #############################################################################
...
Char std_in_ch() { return inch(); }

bool std_in_ch_str(Char *str) { return inchstr(str) == OK; }

//======================================自定义窗口============================================
// 从输入中读取一个字符
Char w_get_ch(NWindow *win) { return wgetch(win); }
// 从输入中读取字符串
bool w_get_str(NWindow *win, char *str) { return wgetstr(win, str) == OK; }
// 从输入中读取指定字符串
...
Char w_in_ch(NWindow *win) { return winch(win); }

bool w_in_ch_str(NWindow *win, Char *str) { return winchstr(win, str) == OK; }
...
const char *get_keyname(int ch) { return keyname(ch); }

const char *get_control_code_name(Char c) { return unctrl(c); }
