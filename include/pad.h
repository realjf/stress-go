...
// 复制pad内容到窗口进行显示
bool std_flush_pad(const WINDOW *pad, int pad_x, int pad_y, int scr_x, int scr_y, int width, int height);

// std_flush_pad() = std_nout_pad() + std_update_pad();
bool std_nout_pad(const WINDOW *pad, int pad_x, int pad_y, int scr_x, int scr_y, int width, int height);
bool std_update_pad();
...
//======================================自定义窗口============================================
// 复制pad内容到窗口进行显示
bool w_flush_pad(const WINDOW *pad, int pad_x, int pad_y, int scr_x, int scr_y, int width, int height);
